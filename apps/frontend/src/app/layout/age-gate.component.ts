  ...
  template: `
    <section *ngIf="visible" class="age-gate-backdrop">
      <div class="panel-card age-gate-card">
        ...
        <p class="muted">
          Naughtybox es una plataforma para mayores de edad. Al continuar declaras que tienes 18 años o más y aceptas
          revisar nuestras normas básicas.
        </p>
        ...
        <div class="age-gate-links">
          <a routerLink="/legal/terms">Términos</a>
